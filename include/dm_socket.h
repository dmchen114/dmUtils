...
#define WM_SOCKET_CLOSE_THREAD						WM_USER + 351
...
typedef struct transport_sink
{
    ...
    int (*OnReceive)(void* pPtr, LPUDPTRANSPORT trans, unsigned char* pbData, unsigned short nLen, unsigned long nPeerIP, unsigned short nPeerPort);
